...
void example1()
{
	...
	size_t rows = 1000;
	size_t cols = 1000;
	Matrix<int> A(rows, cols, 4);// matrix with all elements equal 4
	Matrix<int> B(rows, cols, 1);// matrix with all elements equal 1
	Matrix<int> C(rows, cols, 3);// matrix with all elements equal 3
	Matrix<int> D(rows, cols, 5);// matrix with all elements equal 5
	Matrix<int> sum(rows, cols);// matrix with all elements equal 0
...
void example2()
{
	...
	Matrix<std::complex<int>> A(rows, cols, c1);// matrix with all elements equal 5+i*6
	Matrix<std::complex<int>> B(rows, cols, c2);// matrix with all elements equal 1
	Matrix<std::complex<int>> C(rows, cols, c3);// matrix with all elements equal i*5
	Matrix<std::complex<int>> sum(rows, cols);// matrix with all elements equal 0
...
void example3()
{
	...
	size_t rows = 500;
	size_t cols = 500;
	Matrix<double> A(rows, cols, 4.1);// matrix with all elements equal 4.1
	Matrix<double> B(rows, cols, 1.2);// matrix with all elements equal 1.2
	Matrix<double> C(rows, cols, 3.6);// matrix with all elements equal 3.6
	Matrix<double> D(rows, cols, 5.3);// matrix with all elements equal 5.3
	Matrix<double> sum(rows, cols);// matrix with all elements equal 0
...
void example4()
{
	...
	Matrix<short> B(rows, cols,40);// matrix with all elements equal 40
...
void example5()
{
	...
	Matrix<double> A(100, 500, 4.1);// matrix with all elements equal 4.1
	Matrix<double> B(500, 100, 1.2);// matrix with all elements equal 1.2
	Matrix<double> C(100, 100, 3.6);// matrix with all elements equal 3.6
	Matrix<double> sum(100, 100);// matrix with all elements equal 0
